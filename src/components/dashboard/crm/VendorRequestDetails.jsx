...
const VendorRequestDetails = ({ onClose }) => {
    return (
        <div className="bg-background animate-in slide-in-from-right duration-300">
            {/* Header / Breadcrumb */}
            <div className="flex items-center gap-2 mb-6 text-sm text-muted-foreground">
                <button onClick={onClose} className="hover:text-foreground text-teal-600">Vendor Requests</button>
                <span>/</span>
                <span className="text-foreground font-medium">WESTON MEDICAL EDUCATION FOUNDATION OF INDIA</span>
            </div>

            {/* Title Section */}
            <div className="flex items-center justify-between mb-8">
                <h1 className="text-2xl font-bold text-foreground">WESTON MEDICAL EDUCATION FOUNDATION OF INDIA</h1>
            </div>
            ...
            <div className="grid grid-cols-2 gap-x-16 gap-y-6 max-w-5xl">
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-[140px_1fr] items-baseline">
                        ...
                        <span className="text-sm font-medium text-teal-600 hover:underline cursor-pointer">M K KAKOTI</span>
                    </div>
                    <div className="grid grid-cols-[140px_1fr] items-baseline">
                        <span className="text-xs font-bold text-muted-foreground uppercase flex gap-1">
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-[140px_1fr] items-baseline">
                        ...
                        <div className="flex items-center gap-2">
                            <span className="text-sm text-teal-600">7386510581</span>
                            ...
                            <tbody className="divide-y divide-border">
                                <tr className="hover:bg-muted/50 transition-colors">
                                    <td className="px-4 py-3 flex items-center gap-2">
                                        ...
                                        <span className="text-teal-600">giftcard</span>
                                    </td>
                                    <td className="px-4 py-3 text-right">1</td>
                                </tr>
                                {/* Empty rows filler */}
                                <tr className="h-10 border-b border-border/50 hover:bg-muted/50"><td colSpan={2}></td></tr>
                                <tr className="h-10 border-b border-border/50 hover:bg-muted/50"><td colSpan={2}></td></tr>
                                <tr className="h-10 border-b border-border/50 hover:bg-muted/50"><td colSpan={2}></td></tr>
                            </tbody>
                        </table>
